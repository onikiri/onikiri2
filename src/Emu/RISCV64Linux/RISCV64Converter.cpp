...
namespace {
    ...
    static constexpr int SP = RISCV64Info::REG_SP;
    static constexpr int RA = RISCV64Info::REG_RA;
}
...
RISCV64Converter::OpDef RISCV64Converter::m_OpDefsBase[] = 
{
  ...
  //class
    ...
    { "C.ADDI4SPN", MASK_COMPRESSED_FUNCT3  , OPCODE_COMPRESSED_FUNCT3( 0, 0 )           , 1, { { OpClassCode::iALU     , { R0, -1 }, { R0, I0, -1, -1 },   Set<D0, IntAdd<u64, S0, S1> > } } }, // imm==0 is reserved
    ...
    { "C.BEQZ"    , MASK_COMPRESSED_FUNCT3  , OPCODE_COMPRESSED_FUNCT3( 1, 6 )           , 1, { { OpClassCode::iBC      , { -1, -1 }, { R0,  0, I0, -1 },   RISCV64BranchRelCond<S2, Compare<S0, S1, IntCondEqual<u64> > > } } },
    { "C.BNEZ"    , MASK_COMPRESSED_FUNCT3  , OPCODE_COMPRESSED_FUNCT3( 1, 7 )           , 1, { { OpClassCode::iBC      , { -1, -1 }, { R0,  0, I0, -1 },   RISCV64BranchRelCond<S2, Compare<S0, S1, IntCondNotEqual<u64> > > } } },

...
RISCV64Converter::OpDef RISCV64Converter::m_OpDefsBase[] = 
{
    ...
    { "amoand.w" ,   MASK_ATOMIC,   OPCODE_ATOMIC(2, 12),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, BitAnd    <u32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    { "amoor.w"  ,   MASK_ATOMIC,   OPCODE_ATOMIC(2, 8),    1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, BitOr     <u32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    { "amomin.w" ,   MASK_ATOMIC,   OPCODE_ATOMIC(2, 16),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, RISCV64MIN<s32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    { "amomax.w" ,   MASK_ATOMIC,   OPCODE_ATOMIC(2, 20),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, RISCV64MAX<s32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    { "amominu.w",   MASK_ATOMIC,   OPCODE_ATOMIC(2, 24),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, RISCV64MIN<u32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    { "amomaxu.w",   MASK_ATOMIC,   OPCODE_ATOMIC(2, 28),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },    Store<u32, RISCV64MAX<u32, S1, TeeSetSext<D0, Load<u32, S0> > >, S0>  } } },
    ...
    { "amoand.d" ,   MASK_ATOMIC,   OPCODE_ATOMIC(3, 12),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, BitAnd    <u64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },
    { "amoor.d"  ,   MASK_ATOMIC,   OPCODE_ATOMIC(3, 8),    1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, BitOr     <u64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },
    { "amomin.d" ,   MASK_ATOMIC,   OPCODE_ATOMIC(3, 16),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, RISCV64MIN<s64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },
    { "amomax.d" ,   MASK_ATOMIC,   OPCODE_ATOMIC(3, 20),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, RISCV64MAX<s64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },
    { "amominu.d",   MASK_ATOMIC,   OPCODE_ATOMIC(3, 24),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, RISCV64MIN<u64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },
    { "amomaxu.d",   MASK_ATOMIC,   OPCODE_ATOMIC(3, 28),   1, { { OpClassCode::syscall, { R0, -1 }, { R1, R2, -1, -1 },     Store<u64, RISCV64MAX<u64, S1, TeeSet<D0, Load<u64, S0> > >, S0>  } } },

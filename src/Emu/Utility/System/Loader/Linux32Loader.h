...
#ifndef EMU_UTILITY_LINUX32LOADER_H
#define EMU_UTILITY_LINUX32LOADER_H
...
namespace Onikiri {
    ...
    namespace EmulatorUtility {
        ...
        // 32-bit Linux (ELF) 用のローダー
        class Linux32Loader : public LoaderIF
        {
        public:
            Linux32Loader(u16 machine);
            virtual ~Linux32Loader();
        ...
        protected:
            virtual u64 CalculateEntryPoint(EmulatorUtility::MemorySystem* memory, const EmulatorUtility::Elf32Reader& elfReader);
            virtual void CalculateOthers(EmulatorUtility::MemorySystem* memory, const EmulatorUtility::Elf32Reader& elfReader);
            u64 GetInitialSp() const;
            bool IsBigEndian() const;

        private:
            //static const u64 ADDR_STACK_TAIL = 0xc000000 - 1;
            static const u64 ADDR_STACK_TAIL = 0xf7000000 - 1;

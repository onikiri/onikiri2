...
void RISCV32LinuxSyscallConv::syscall_getsysinfo(OpEmulationState* opState)
{
    u64 kind = GetArg(1);
    u64 buffer = GetArg(2);
...
void RISCV32LinuxSyscallConv::syscall_setsysinfo(OpEmulationState* opState)
{
    u64 kind = GetArg(1);
//  u64 buffer = GetArg(2);
...
//void RISCV32LinuxSyscallConv::write_stat64(u64 dest, const HostStat &src)
//{
//  static u32 RISCV32LinuxSyscallConst_host_st_mode[] =
//  {
//      POSIX_S_IFDIR,
//      POSIX_S_IFCHR,
//      POSIX_S_IFREG,
//      POSIX_S_IFIFO,
//  };
//  static u32 RISCV32LinuxSyscallConst_alpha_st_mode[] =
//  {
//      0040000, // _S_IFDIR
//      0020000, // _S_IFCHR
//      0100000, // _S_IFREG
//      0010000, // _S_IFIFO
//  };
//  static int RISCV32LinuxSyscallConst_st_mode_size = sizeof(RISCV32LinuxSyscallConst_host_st_mode)/sizeof(RISCV32LinuxSyscallConst_host_st_mode[0]);
//  SyscallConstConvEnum conv(
//      RISCV32LinuxSyscallConst_host_st_mode,
//      RISCV32LinuxSyscallConst_alpha_st_mode, 
//      RISCV32LinuxSyscallConst_st_mode_size);
//
...
{
    static u32 RISCV32LinuxSyscallConst_host_open_flags[] =
    {
...
//    O_SYNC,
    ...
    static u32 RISCV32LinuxSyscallConst_alpha_open_flags[] =
    {
...
//    040000,   // O_SYNC
    ...
    static int RISCV32LinuxSyscallConst_open_flags_size = sizeof(RISCV32LinuxSyscallConst_host_open_flags)/sizeof(RISCV32LinuxSyscallConst_host_open_flags[0]);

    SyscallConstConvBitwise conv(
        RISCV32LinuxSyscallConst_host_open_flags,
        RISCV32LinuxSyscallConst_alpha_open_flags, 
        RISCV32LinuxSyscallConst_open_flags_size);

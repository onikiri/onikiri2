...
inline void RISCVPALHalt(EmulatorUtility::OpEmulationState* opState)
{
    THROW_RUNTIME_ERROR("RISCVPALHalt called.");    // <TODO>
}

// memory barrier
inline void RISCVPALIMB(EmulatorUtility::OpEmulationState* opState)
{
    // シングルスレッドなので何もしない
}

// read thread-unique value
inline void RISCVPALRdUniq(EmulatorUtility::OpEmulationState* opState)
{
    DstOperand<0>::SetOperand( opState, opState->GetProcessState()->GetThreadUniqueValue() );
}

// write thread-unique value
inline void RISCVPALWrUniq(EmulatorUtility::OpEmulationState* opState)
{
    opState->GetProcessState()->SetThreadUniqueValue( SrcOperand<0>()(opState) );
}

inline void RISCVPALGenTrap(EmulatorUtility::OpEmulationState* opState)
{
    THROW_RUNTIME_ERROR("RISCVPALGenTrap called."); // <TODO>
}
...
inline void RISCVSyscallSetArg(EmulatorUtility::OpEmulationState* opState)
{
...
inline void RISCVSyscallCore(EmulatorUtility::OpEmulationState* opState)
{
    EmulatorUtility::SyscallConvIF* syscallConv = opState->GetProcessState()->GetSyscallConv();
...
struct RISCVCompare : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
...
template <typename TSrc1, typename TSrc2, typename Comp>
struct RISCVTFloatCompare : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        if ( Comp()(TSrc1()(opState), TSrc2()(opState)) ) {
...
struct RISCVFPCondUnordered : public std::binary_function<ArgType, ArgType, bool>
{
...
struct RISCVAddr : public std::unary_function<EmulatorUtility::OpEmulationState, RegisterType>
{
...
// ldq_u, stq_u 用アドレス計算
template<typename TSrc1, typename TSrc2>
struct RISCVAddrUnaligned : public std::unary_function<EmulatorUtility::OpEmulationState, RegisterType>
{
    RegisterType operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template<typename TSrc1, typename TSrc2>
struct RISCVLdah : public std::unary_function<EmulatorUtility::OpEmulationState, RegisterType>
{
    RegisterType operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
// byte-wise compare
template<typename TSrc1, typename TSrc2>
struct RISCVCmpBge : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
...
struct RISCVExtxl : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 result = 0;
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVExtxh : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 result = 0;
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVInsxl : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVInsxh : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVMskxl : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVMskxh : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
...
inline u64 RISCVZapNotBitMask(u64 byte_mask)
{
    u64 result = 0;
...
template <typename TSrc1, typename TSrc2>
struct RISCVZap : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
        ...
        return lhs & RISCVZapNotBitMask(rhs);
    }
};

template <typename TSrc1, typename TSrc2>
struct RISCVZapNot : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 lhs = TSrc1()(opState);
...
struct RISCVSextb : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template <typename TSrc1>
struct RISCVSextw : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
// FIX
template <typename TSrc1>
struct RISCVFtois : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template <typename TSrc1>
struct RISCVItofs : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 result;
...
struct RISCVPackLongWords : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
...
template <typename TSrc>
struct RISCVPackWords : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 val = TSrc()(opState);
...
template <typename TSrc>
struct RISCVUnpackLongWords : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 val = TSrc()(opState);
...
template <typename TSrc>
struct RISCVUnpackWords : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 val = TSrc()(opState);
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVVectorMin : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
...
template <typename Type, typename TSrc1, typename TSrc2>
struct RISCVVectorMax : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 src1 = TSrc1()(opState);
...
template <typename TSrc1, typename TSrc2>
struct RISCVPixelError : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 src1 = TSrc1()(opState);
...
struct RISCVRoundModeFromFPCR : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
...
template <typename TSrc1>
struct RISCVCvtLQ : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 va = TSrc1()(opState);
...
template <typename TSrc1>
struct RISCVCvtQL : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        u64 va = TSrc1()(opState);
...
template <typename TSrc1>
struct RISCVCvtQS : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template <typename TSrc1>
struct RISCVCvtQT : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template <typename TSrc1>
struct RISCVCvtTS : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
...
template <typename TSrc1>
struct RISCVCvtTQ_c : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        double va = AsFPFunc<double>( TSrc1()(opState) );
...
template <typename TSrc1>
struct RISCVCvtTQ_m : public std::unary_function<EmulatorUtility::OpEmulationState, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState) const
    {
        double va = AsFPFunc<double>( TSrc1()(opState) );
...
struct RISCVLds : public std::unary_function<EmulatorUtility::OpEmulationState*, u64>
{
    u64 operator()(EmulatorUtility::OpEmulationState* opState)
    {
        u64 result;
...
inline void RISCVSts(EmulatorUtility::OpEmulationState* opState)
{
    u64 va = TSrc()(opState);

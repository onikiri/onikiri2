...
RISCV32Converter::OpDef RISCV32Converter::m_OpDefsBase[] = 
{
    ...
    // pal
    //
    {"halt",    MASK_PAL, OPCODE_PAL(0x00, PAL_HALT),       1, {{OpClassCode::syscall,  {-1, -1}, {-1, -1, -1, -1}, RISCVPALHalt}}},
    {"imb",     MASK_PAL, OPCODE_PAL(0x00, PAL_IMB),        1, {{OpClassCode::syscall,  {-1, -1}, {-1, -1, -1, -1}, RISCVPALIMB}}},
    {"rduniq",  MASK_PAL, OPCODE_PAL(0x00, PAL_RDUNIQ),     1, {{OpClassCode::syscall,  { 0, -1}, {-1, -1, -1, -1}, RISCVPALRdUniq}}},
    {"wruniq",  MASK_PAL, OPCODE_PAL(0x00, PAL_WRUNIQ),     1, {{OpClassCode::syscall,  {-1, -1}, {16, -1, -1, -1}, RISCVPALWrUniq}}},
    {"gentrap", MASK_PAL, OPCODE_PAL(0x00, PAL_GENTRAP),    1, {{OpClassCode::syscall,  {-1, -1}, {-1, -1, -1, -1}, RISCVPALGenTrap}}},

    // system call
    {"callsys", MASK_PAL, OPCODE_PAL(0x00, PAL_CALLSYS),    2, {
        {OpClassCode::syscall,  {-1, -1}, { 0, 16, 17, -1}, RISCVSyscallSetArg},
        {OpClassCode::syscall_branch,   { 0, 19}, {18, 19, 20, -1}, RISCVSyscallCore},
    }},
    ...
    {"cmpeq",   MASK_OPI, OPCODE_OPI(0x10, 0x2d),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondEqual<u64> > >}}},
    {"cmpeq",   MASK_OPI, OPCODE_OPIL(0x10, 0x2d),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondEqual<u64> > >}}},

    {"cmplt",   MASK_OPI, OPCODE_OPI(0x10, 0x4d),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessSigned<u64> > >}}},
    {"cmplt",   MASK_OPI, OPCODE_OPIL(0x10, 0x4d),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessSigned<u64> > >}}},

    {"cmple",   MASK_OPI, OPCODE_OPI(0x10, 0x6d),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessEqualSigned<u64> > >}}},
    {"cmple",   MASK_OPI, OPCODE_OPIL(0x10, 0x6d),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessEqualSigned<u64> > >}}},

    {"cmpult",  MASK_OPI, OPCODE_OPI(0x10, 0x1d),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessUnsigned<u64> > >}}},
    {"cmpult",  MASK_OPI, OPCODE_OPIL(0x10, 0x1d),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessUnsigned<u64> > >}}},

    {"cmpule",  MASK_OPI, OPCODE_OPI(0x10, 0x3d),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessEqualUnsigned<u64> > >}}},
    {"cmpule",  MASK_OPI, OPCODE_OPIL(0x10, 0x3d),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCompare< S0, S1, IntCondLessEqualUnsigned<u64> > >}}},
    ...
    // byte-wise
    {"cmpbge",  MASK_OPI, OPCODE_OPI(0x10, 0x0f),   1, {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVCmpBge< S0, S1 > >}}},
    {"cmpbge",  MASK_OPI, OPCODE_OPIL(0x10, 0x0f),  1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVCmpBge< S0, S1 > >}}},

    {"extbl",   MASK_OPI, OPCODE_OPI(0x12, 0x06),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxl<  u8, S0, S1 > >}}},
    {"extbl",   MASK_OPI, OPCODE_OPIL(0x12, 0x06),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxl<  u8, S0, S1 > >}}},

    {"extwl",   MASK_OPI, OPCODE_OPI(0x12, 0x16),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxl< u16, S0, S1 > >}}},
    {"extwl",   MASK_OPI, OPCODE_OPIL(0x12, 0x16),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxl< u16, S0, S1 > >}}},

    {"extll",   MASK_OPI, OPCODE_OPI(0x12, 0x26),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxl< u32, S0, S1 > >}}},
    {"extll",   MASK_OPI, OPCODE_OPIL(0x12, 0x26),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxl< u32, S0, S1 > >}}},

    {"extql",   MASK_OPI, OPCODE_OPI(0x12, 0x36),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxl< u64, S0, S1 > >}}},
    {"extql",   MASK_OPI, OPCODE_OPIL(0x12, 0x36),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxl< u64, S0, S1 > >}}},

    {"extwh",   MASK_OPI, OPCODE_OPI(0x12, 0x5a),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxh< u16, S0, S1 > >}}},
    {"extwh",   MASK_OPI, OPCODE_OPIL(0x12, 0x5a),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxh< u16, S0, S1 > >}}},

    {"extlh",   MASK_OPI, OPCODE_OPI(0x12, 0x6a),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxh< u32, S0, S1 > >}}},
    {"extlh",   MASK_OPI, OPCODE_OPIL(0x12, 0x6a),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxh< u32, S0, S1 > >}}},

    {"extqh",   MASK_OPI, OPCODE_OPI(0x12, 0x7a),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVExtxh< u64, S0, S1 > >}}},
    {"extqh",   MASK_OPI, OPCODE_OPIL(0x12, 0x7a),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVExtxh< u64, S0, S1 > >}}},

    {"insbl",   MASK_OPI, OPCODE_OPI(0x12, 0x0b),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxl<  u8, S0, S1 > >}}},
    {"insbl",   MASK_OPI, OPCODE_OPIL(0x12, 0x0b),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxl<  u8, S0, S1 > >}}},

    {"inswl",   MASK_OPI, OPCODE_OPI(0x12, 0x1b),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxl< u16, S0, S1 > >}}},
    {"inswl",   MASK_OPI, OPCODE_OPIL(0x12, 0x1b),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxl< u16, S0, S1 > >}}},

    {"insll",   MASK_OPI, OPCODE_OPI(0x12, 0x2b),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxl< u32, S0, S1 > >}}},
    {"insll",   MASK_OPI, OPCODE_OPIL(0x12, 0x2b),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxl< u32, S0, S1 > >}}},

    {"insql",   MASK_OPI, OPCODE_OPI(0x12, 0x3b),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxl< u64, S0, S1 > >}}},
    {"insql",   MASK_OPI, OPCODE_OPIL(0x12, 0x3b),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxl< u64, S0, S1 > >}}},

    {"inswh",   MASK_OPI, OPCODE_OPI(0x12, 0x57),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxh< u16, S0, S1 > >}}},
    {"inswh",   MASK_OPI, OPCODE_OPIL(0x12, 0x57),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxh< u16, S0, S1 > >}}},

    {"inslh",   MASK_OPI, OPCODE_OPI(0x12, 0x67),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxh< u32, S0, S1 > >}}},
    {"inslh",   MASK_OPI, OPCODE_OPIL(0x12, 0x67),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxh< u32, S0, S1 > >}}},

    {"insqh",   MASK_OPI, OPCODE_OPI(0x12, 0x77),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVInsxh< u64, S0, S1 > >}}},
    {"insqh",   MASK_OPI, OPCODE_OPIL(0x12, 0x77),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVInsxh< u64, S0, S1 > >}}},

    {"mskbl",   MASK_OPI, OPCODE_OPI(0x12, 0x02),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxl<  u8, S0, S1 > >}}},
    {"mskbl",   MASK_OPI, OPCODE_OPIL(0x12, 0x02),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxl<  u8, S0, S1 > >}}},

    {"mskwl",   MASK_OPI, OPCODE_OPI(0x12, 0x12),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxl< u16, S0, S1 > >}}},
    {"mskwl",   MASK_OPI, OPCODE_OPIL(0x12, 0x12),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxl< u16, S0, S1 > >}}},

    {"mskll",   MASK_OPI, OPCODE_OPI(0x12, 0x22),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxl< u32, S0, S1 > >}}},
    {"mskll",   MASK_OPI, OPCODE_OPIL(0x12, 0x22),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxl< u32, S0, S1 > >}}},

    {"mskql",   MASK_OPI, OPCODE_OPI(0x12, 0x32),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxl< u64, S0, S1 > >}}},
    {"mskql",   MASK_OPI, OPCODE_OPIL(0x12, 0x32),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxl< u64, S0, S1 > >}}},

    {"mskwh",   MASK_OPI, OPCODE_OPI(0x12, 0x52),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxh< u16, S0, S1 > >}}},
    {"mskwh",   MASK_OPI, OPCODE_OPIL(0x12, 0x52),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxh< u16, S0, S1 > >}}},

    {"msklh",   MASK_OPI, OPCODE_OPI(0x12, 0x62),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxh< u32, S0, S1 > >}}},
    {"msklh",   MASK_OPI, OPCODE_OPIL(0x12, 0x62),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxh< u32, S0, S1 > >}}},

    {"mskqh",   MASK_OPI, OPCODE_OPI(0x12, 0x72),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVMskxh< u64, S0, S1 > >}}},
    {"mskqh",   MASK_OPI, OPCODE_OPIL(0x12, 0x72),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVMskxh< u64, S0, S1 > >}}},

    {"zap", MASK_OPI, OPCODE_OPI(0x12, 0x30),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVZap< S0, S1 > >}}},
    {"zap", MASK_OPI, OPCODE_OPIL(0x12, 0x30),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVZap< S0, S1 > >}}},

    {"zapnot",  MASK_OPI, OPCODE_OPI(0x12, 0x31),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVZapNot< S0, S1 > >}}},
    {"zapnot",  MASK_OPI, OPCODE_OPIL(0x12, 0x31),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVZapNot< S0, S1 > >}}},

    // BWX
    {"sextb",   MASK_OPI, OPCODE_OPI(0x1c, 0x00),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVSextb< S1 > >}}},
    {"sextb",   MASK_OPI, OPCODE_OPIL(0x1c, 0x00),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVSextb< S1 > >}}},
    {"sextw",   MASK_OPI, OPCODE_OPI(0x1c, 0x01),   1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVSextw< S1 > >}}},
    {"sextw",   MASK_OPI, OPCODE_OPIL(0x1c, 0x01),  1, {{OpClassCode::iBYTE,    {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVSextw< S1 > >}}},
    ...
    // <TODO> /d : 動的モードへの対応
    // ↓こんな感じで可能.
    // {"adds/sud", MASK_OPF, OPCODE_OPF(0x16, 0x5c0),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, Cast< double, FPAdd< float, SF0, SF1, RISCVRoundModeFromFPCR<S2> > >}}},
    ...
    {"addt/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5e0),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, FPAdd< double, SD0, SD1, RISCVRoundModeFromFPCR<S2>  > >}}},
    ...
    {"subt/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5e1),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, FPSub< double, SD0, SD1, RISCVRoundModeFromFPCR<S2>  > >}}},
    ...
    {"muls/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5c2),  1, {{OpClassCode::fMUL, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, Cast< double, FPMul< float, SF0, SF1, RISCVRoundModeFromFPCR<S2>  > > >}}},
    ...
    {"mult/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5e2),  1, {{OpClassCode::fMUL, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, FPMul< double, SD0, SD1, RISCVRoundModeFromFPCR<S2>  > >}}},
    ...
    {"divs/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5c3),  1, {{OpClassCode::fDIV, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, Cast< double, FPDiv< float, SF0, SF1, RISCVRoundModeFromFPCR<S2>  > > >}}},  
    ...
    {"divt/sud",    MASK_OPF, OPCODE_OPF(0x16, 0x5e3),  1, {{OpClassCode::fDIV, {R0, -1}, {R1, R2,FPC, -1}, SetFP< D0, FPDiv< double, SD0, SD1, RISCVRoundModeFromFPCR<S2>  > >}}},

    {"cmpteq",  MASK_OPI, OPCODE_OPF(0x16, 0x0a5),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondEqual<f64> > >}}},
    {"cmptlt",  MASK_OPI, OPCODE_OPF(0x16, 0x0a6),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondLess<f64> > >}}},
    {"cmptle",  MASK_OPI, OPCODE_OPF(0x16, 0x0a7),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondLessEqual<f64> > >}}},
    {"cmptun",  MASK_OPI, OPCODE_OPF(0x16, 0x0a4),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, RISCVFPCondUnordered<f64> > >}}},
    {"cmptun/su",   MASK_OPI, OPCODE_OPF(0x16, 0x5a4),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, RISCVFPCondUnordered<f64> > >}}},

    {"cmpteq/su",   MASK_OPI, OPCODE_OPF(0x16, 0x5a5),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondEqual<f64> > >}}},
    {"cmptlt/su",   MASK_OPI, OPCODE_OPF(0x16, 0x5a6),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondLess<f64> > >}}},
    {"cmptle/su",   MASK_OPI, OPCODE_OPF(0x16, 0x5a7),  1, {{OpClassCode::fADD, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVTFloatCompare< S0, S1, FPCondLessEqual<f64> > >}}},

    {"cvtqs",   MASK_OPF, OPCODE_OPF(0x16, 0x0bc),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQS< S0 > >}}},
    {"cvtqs/d", MASK_OPF, OPCODE_OPF(0x16, 0x0fc),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQS< S0 > >}}},

    {"cvtqt",   MASK_OPF, OPCODE_OPF(0x16, 0x0be),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQT< S0 > >}}},
    {"cvtqt/m", MASK_OPF, OPCODE_OPF(0x16, 0x07e),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQT< S0 > >}}}, // m?
    {"cvtqt/d", MASK_OPF, OPCODE_OPF(0x16, 0x0fe),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQT< S0 > >}}}, // d?
    {"cvtts",   MASK_OPF, OPCODE_OPF(0x16, 0x0ac),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTS< S0 > >}}},
    {"cvtts/su",    MASK_OPF, OPCODE_OPF(0x16, 0x5ac),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTS< S0 > >}}},
    {"cvtts/sud",   MASK_OPF, OPCODE_OPF(0x16, 0x5ec),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTS< S0 > >}}}, // d?
    {"cvttq/c", MASK_OPF, OPCODE_OPF(0x16, 0x02f),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTQ_c< S0 > >}}},
    {"cvttq/svc",   MASK_OPF, OPCODE_OPF(0x16, 0x52f),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTQ_c< S0 > >}}},
    {"cvttq/svm",   MASK_OPF, OPCODE_OPF(0x16, 0x56f),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTQ_m< S0 > >}}},   // floor
    {"cvttq/svd",   MASK_OPF, OPCODE_OPF(0x16, 0x5ef),  1, {{OpClassCode::fCONV,    {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtTQ_m< S0 > >}}},   // d?
    ...
    {"cvtlq",   MASK_OPF, OPCODE_OPF(0x17, 0x010),  1, {{OpClassCode::fMOV, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtLQ< S0 > >}}},
    {"cvtql",   MASK_OPF, OPCODE_OPF(0x17, 0x030),  1, {{OpClassCode::fMOV, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQL< S0 > >}}},
    {"cvtql/v", MASK_OPF, OPCODE_OPF(0x17, 0x130),  1, {{OpClassCode::fMOV, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQL< S0 > >}}},
    {"cvtql/sv",    MASK_OPF, OPCODE_OPF(0x17, 0x530),  1, {{OpClassCode::fMOV, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVCvtQL< S0 > >}}},
    ...
    {"sqrts/sud",   MASK_OPF, OPCODE_OPF(0x14, 0x5cb),  1, {{OpClassCode::fELEM, {R0, -1}, {R2, FPC, -1, -1}, SetFP< D0, Cast< double, FPSqrt< float, SF0, RISCVRoundModeFromFPCR<S1> > > >}}},
    ...
    {"sqrtt/sud",   MASK_OPF, OPCODE_OPF(0x14, 0x5eb),  1, {{OpClassCode::fELEM, {R0, -1}, {R2, FPC, -1, -1}, SetFP< D0, FPSqrt< double, SD0, RISCVRoundModeFromFPCR<S1> > >}}},
    {"ftois",   MASK_OPF, OPCODE_OPF(0x1c, 0x078),  1, {{OpClassCode::ifCONV, {R0, -1}, {R1, -1, -1, -1}, Set< D0, Cast< s64, RISCVFtois<S0> > >}}},
    {"ftoit",   MASK_OPF, OPCODE_OPF(0x1c, 0x070),  1, {{OpClassCode::ifCONV, {R0, -1}, {R1, -1, -1, -1}, Set< D0, S0 >}}},
    {"itofs",   MASK_OPF, OPCODE_OPF(0x14, 0x004),  1, {{OpClassCode::ifCONV, {R0, -1}, {R1, -1, -1, -1}, Set< D0, RISCVItofs<S0> >}}},
    ...
    // MAX 命令
    {"pklb",    MASK_OPI, OPCODE_OPI(0x1c, 0x37),   1,  {{OpClassCode::iALU, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVPackLongWords<S0> >}}},
    {"pkwb",    MASK_OPI, OPCODE_OPI(0x1c, 0x36),   1,  {{OpClassCode::iALU, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVPackWords<S0> >}}},
    {"unpkbl",  MASK_OPI, OPCODE_OPI(0x1c, 0x35),   1,  {{OpClassCode::iALU, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVUnpackLongWords<S0> >}}},
    {"unpkbw",  MASK_OPI, OPCODE_OPI(0x1c, 0x34),   1,  {{OpClassCode::iALU, {R0, -1}, {R2, -1, -1, -1}, Set< D0, RISCVUnpackWords<S0> >}}},
    {"minub8",  MASK_OPI, OPCODE_OPI(0x1c, 0x3a),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMin<u8,S0,S1> >}}},
    {"minub8i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3a),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMin<u8,S0,S1> >}}},
    {"minsb8",  MASK_OPI, OPCODE_OPI(0x1c, 0x38),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMin<s8,S0,S1> >}}},
    {"minsb8i", MASK_OPI, OPCODE_OPIL(0x1c, 0x38),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMin<s8,S0,S1> >}}},
    {"minuw4",  MASK_OPI, OPCODE_OPI(0x1c, 0x3b),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMin<u16,S0,S1> >}}},
    {"minuw4i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3b),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMin<u16,S0,S1> >}}},
    {"minsw4",  MASK_OPI, OPCODE_OPI(0x1c, 0x39),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMin<s16,S0,S1> >}}},
    {"minsw4i", MASK_OPI, OPCODE_OPIL(0x1c, 0x39),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMin<s16,S0,S1> >}}},
    {"maxub8",  MASK_OPI, OPCODE_OPI(0x1c, 0x3c),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMax<u8,S0,S1> >}}},
    {"maxub8i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3c),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMax<u8,S0,S1> >}}},
    {"maxsb8",  MASK_OPI, OPCODE_OPI(0x1c, 0x3e),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMax<s8,S0,S1> >}}},
    {"maxsb8i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3e),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMax<s8,S0,S1> >}}},
    {"maxuw4",  MASK_OPI, OPCODE_OPI(0x1c, 0x3d),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMax<u16,S0,S1> >}}},
    {"maxuw4i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3d),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMax<u16,S0,S1> >}}},
    {"maxsw4",  MASK_OPI, OPCODE_OPI(0x1c, 0x3f),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVVectorMax<s16,S0,S1> >}}},
    {"maxsw4i", MASK_OPI, OPCODE_OPIL(0x1c, 0x3f),  1,  {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVVectorMax<s16,S0,S1> >}}},
    {"perr",    MASK_OPI, OPCODE_OPI(0x1c, 0x31),   1,  {{OpClassCode::iALU, {R0, -1}, {R1, R2, -1, -1}, Set< D0, RISCVPixelError<S0,S1> >}}},
...
//  {"jsr_coroutine",   MASK_JMP, OPCODE_JMP(0x1a, 0x3),    1, {{OpClassCode::iBU,  {R0, -1}, {R1, -1, -1, -1}, alpha_jsr_coroutine< D0, S0 >}}},
    ...
    // memory
    //
    {"lda",     MASK_MEM, OPCODE_MEM(0x08), 1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVAddr< S0, S1 > >}}},
    {"ldah",    MASK_MEM, OPCODE_MEM(0x09), 1, {{OpClassCode::iALU, {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVLdah< S0, S1 > >}}},
...
// split load Store
//
RISCV32Converter::OpDef RISCV32Converter::m_OpDefsSplitLoadStore[] =
{
    {"ldq_u",   MASK_MEM, OPCODE_MEM(0x0b), 2, {
        {OpClassCode::ADDR, {T0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVAddrUnaligned< S0, S1 > >},
    ...
    {"ldl",     MASK_MEM, OPCODE_MEM(0x28), 2, {
        {OpClassCode::ADDR, {T0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVAddr< S0, S1 > >},
    ...
    {"lds",     MASK_MEM, OPCODE_MEM(0x22), 2, {
        {OpClassCode::ADDR, {T0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVAddr< S0, S1 > >},
        {OpClassCode::fLD,  {R0, -1}, {T0, -1, -1, -1}, Set< D0, RISCVLds< S0 > >}
    }},
    ...
    {"sts",     MASK_MEM, OPCODE_MEM(0x26), 2, {
        {OpClassCode::ADDR, {T0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVAddr< S0, S1 > >},
        {OpClassCode::fST,  {-1, -1}, {R2, T0, -1, -1}, RISCVSts< S0, S1 >}
    }},
...
//
RISCV32Converter::OpDef RISCV32Converter::m_OpDefsNonSplitLoadStore[] =
{
    {"ldq_u",   MASK_MEM, OPCODE_MEM(0x0b), 1, {
        {OpClassCode::iLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, Load< u64, RISCVAddrUnaligned< S0, S1 > > >}
    }},
    {"stq_u",   MASK_MEM, OPCODE_MEM(0x0f), 1, {
        {OpClassCode::iST,      {-1, -1}, {R2, R1, I0, -1}, Store< u64, S0, RISCVAddrUnaligned< S1, S2> >}
    }},

    {"ldl",     MASK_MEM, OPCODE_MEM(0x28), 1, {
        {OpClassCode::iLD,      {R0, -1}, {R1, I0, -1, -1}, SetSext< D0, Load< u32, RISCVAddr< S0, S1 > > >}
    }},
    {"ldq",     MASK_MEM, OPCODE_MEM(0x29), 1, {
        {OpClassCode::iLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, Load< u64, RISCVAddr< S0, S1 > > >}
    }},
    ...
    {"stl",     MASK_MEM, OPCODE_MEM(0x2c), 1, {
        {OpClassCode::iST,      {-1, -1}, {R2, R1, I0, -1}, Store< u32, S0, RISCVAddr< S1, S2> >}
    }},
    {"stq",     MASK_MEM, OPCODE_MEM(0x2d), 1, {
        {OpClassCode::iST,      {-1, -1}, {R2, R1, I0, -1}, Store< u64, S0, RISCVAddr< S1, S2> >}
    }},
    ...
    {"lds",     MASK_MEM, OPCODE_MEM(0x22), 1, {
        {OpClassCode::fLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, RISCVLds< RISCVAddr< S0, S1 > > >}
    }},
    {"ldt",     MASK_MEM, OPCODE_MEM(0x23), 1, {
        {OpClassCode::fLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, Load< u64, RISCVAddr< S0, S1 > > >}
    }},
    {"sts",     MASK_MEM, OPCODE_MEM(0x26), 1, {
        {OpClassCode::fST,      {-1, -1}, {R2, R1, I0, -1}, RISCVSts< S0, RISCVAddr< S1, S2 > >}
    }},
    {"stt",     MASK_MEM, OPCODE_MEM(0x27), 1, {
        {OpClassCode::fST,      {-1, -1}, {R2, R1, I0, -1}, Store< u64, S0, RISCVAddr< S1, S2 > >}
    }},


    // BWX
    {"ldbu",        MASK_MEM, OPCODE_MEM(0x0a), 1, {
        {OpClassCode::iLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, Load< u8, RISCVAddr< S0, S1 > > >}
    }},
    {"ldwu",        MASK_MEM, OPCODE_MEM(0x0c), 1, {
        {OpClassCode::iLD,      {R0, -1}, {R1, I0, -1, -1}, Set< D0, Load< u16, RISCVAddr< S0, S1 > > >}
    }},
    {"stb",     MASK_MEM, OPCODE_MEM(0x0e), 1, {
        {OpClassCode::iST,      {-1, -1}, {R2, R1, I0, -1}, Store< u8, S0, RISCVAddr< S1, S2> >}
    }},
    {"stw",     MASK_MEM, OPCODE_MEM(0x0d), 1, {
        {OpClassCode::iST,      {-1, -1}, {R2, R1, I0, -1}, Store< u16, S0, RISCVAddr< S1, S2> >}
    }},
};

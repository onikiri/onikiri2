...
#ifndef SIM_PIPELINE_FETCHER_FETCH_THREAD_STEERER_BASE_H
#define SIM_PIPELINE_FETCHER_FETCH_THREAD_STEERER_BASE_H
...
#endif // SIM_PIPELINE_FETCHER_FETCH_THREAD_STEERER_BASE_H
